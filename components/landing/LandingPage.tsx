    ...
    <div className="min-h-screen bg-[var(--bg)] flex flex-col">
      <nav className="flex items-center justify-between px-6 md:px-10 py-4 shrink-0">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-md bg-[#FAFF00] flex items-center justify-center">
            <span className="text-zinc-950 text-xs font-bold">G</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <Link href="/login" className="px-4 py-1.5 rounded-md text-[11px] font-semibold tracking-wide border border-[#FAFF00] text-[#FAFF00] hover:bg-[#FAFF00] hover:text-zinc-950 transition-colors">
            GET STARTED
          </Link>
        </div>
      </nav>
        ...
        <div className="max-w-5xl mx-auto w-full">
          <div className="text-center mb-12 md:mb-16">
            ...
            >
              <Link href="/login" className="inline-block">
                <motion.div
                  className="px-8 py-3.5 rounded-xl font-semibold text-base bg-[#FAFF00] text-zinc-950 cursor-pointer"
          ...
          >
            {features.map((f, i) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg border border-[#FAFF00]/30 bg-[#FAFF00]/5 flex items-center justify-center mb-4">
                  <f.icon size={18} className="text-[#FAFF00]" />
                </div>
